...
def handle_radar(message):
    bot.reply_to(message, "📡 *Escaneando altcoins en KuCoin por orden tuya...*", parse_mode='Markdown')
...
# Tarea automática en segundo plano (SOLO REPORTES CADA 15M)
def background_auto_analyzer():
    time.sleep(30) # Espera a que encienda el bot
    while True:
        try:
        ...
        time.sleep(900) # Duerme 15 minutos exactos
